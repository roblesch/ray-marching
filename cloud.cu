...
__device__ double fixed_mono_diffuse(double T, const ray& r, vec3 N, std::vector<light> lights) {
...
__device__ double gardner_noise(vec3 p) {
...
__device__ vec3 gardner_cloud_2d::color(const ray& r, vec3 p, vec3 N, std::vector<light> lights) const {
...
__device__ vec3 perlin_cloud_2d::color(const ray& r, vec3 p, vec3 N, std::vector<light> lights) const {
...
__device__ vec3 gardner_cloud_3d::color(const ray& r, vec3 p, vec3 N, std::vector<light> lights) const {
...
__device__ vec3 perlin_cloud_3d::color(const ray& r, vec3 p, vec3 N, std::vector<light> lights) const {
